...
ACO::ACO(double alpha, double beta, double q, double ro, double taumax,
		   int initCity)
{
	ALPHA = alpha;
	BETA = beta;
...
// bool ACO::visited (int antk, int size,  int c) {
...
double ACO::PHI(int cityi, int cityj, int *visited)
{
...
void ACO::perturbationPHEROMONES()
{
	double sum = 0;
